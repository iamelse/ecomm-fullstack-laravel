                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="descrioption" id="editor" cols="30" rows="4" class="form-control">Hello</textarea>
                                        </div>
                                    </div>
                                    <div class="col">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="gallery-container">
                                        <img src="/images/product-mavic_kawe.jpg" alt="" class="w-100" />
                                ...
                                <div class="col-md-4">
                                    <div class="gallery-container">
                                        <img src="/images/product-black_edition_nike.jpg" alt="" class="w-100" />
                                        <a class="delete-gallery" href="#">
                                            <img src="/images/icon-delete.svg" alt="" />
                                        </a>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="gallery-container">
                                        <img src="/images/product-apple_watch_4.jpg" alt="" class="w-100" />
                                        <a class="delete-gallery" href="#">
                                            <img src="/images/icon-delete.svg" alt="" />
                                        </a>
                                    </div>
