        ...
        <section class="store-gallery" id="gallery">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="row">
                            <div class="col-3 col-lg-12 mt-2 mt-lg-2" v-for="(photo, index) in photos" v-bind:key="photo.id" data-aos="zoom-in" data-aos-delay="100">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="owner">By Lana Septiana</div>
                            <div class="price">$1,320</div>
                        </div>
                        <div class="col-lg-2" data-aos="zoom-in">
                            <a href="/cart.html" class="btn btn-success nav-link p-x text-white btn-block mb-3">
                            Add to cart
                            </a>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-8">
                            ...
                            <p>Bring the past into the future with the Nike Air Max 2090, a bold look inspired by the DNA of the iconic Air Max 90. Brand-new Nike Air cushioning underfoot adds unparalleled comfort while transparent mesh and vibrantly coloured
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8">
                            <ul class="list-unstyled">
                                <li class="media">
                                    <img src="/images/user_pc.png" class="mr-3 rounded-circle">
